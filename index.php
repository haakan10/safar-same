...
<head>
    ...
    <title>Safar-same Bookings</title>
    <!-- google fonts -->
...
<body >
    ...
    <header>
        <nav>
            <div>
                <a href="#" class="nav-item nav-logo">Safar-same</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Safar-same Bus</h1>

            <p class="text-center">Welcome to Safar-same Bus System. Login now to manage Safar-same Bus and much more. OR, simply scroll down to check the Safar-same Bus using Passenger Name Record </p>
    ...
    <div id="block">
        ...
        <footer>
            <p>
                <i class="far fa-copyright"></i> <?php echo date('Y'); ?> - Safar-same Bus System | AllRight Reserved Safar-same Bus
            </p>
        </footer>
    </div>
