...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>Summury Report about customer</h2>
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>customer_created</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $sn = 1;
                        $user_qry = "select *from customers";
                        $user_res = mysqli_query($con, $user_qry);
                        while ($user_data = mysqli_fetch_assoc($user_res)) { ?>
                            <tr>
                                <td><?php echo $user_data['id'];  ?></td>
                                <td><?php echo $user_data['customer_id'];  ?></td>
                                <td><?php echo $user_data['customer_name'];  ?></td>
                                <td><?php echo $user_data['customer_phone'];  ?></td>
                                <td><?php echo $user_data['customer_created'];  ?></td>
                            </tr>
                        <?php
                            $sn++;
                        }
                ...
                <div class="text-center">
                    <button> <a href="customerPrint.php" class="btn btn-primary" id="print-btn">Back</a> </button>
